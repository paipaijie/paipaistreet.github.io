...
?>
			...
			<p class="copyright_info"><?php echo $this->_var['lang']['icp_number']; ?>:<a href="http://www.miibeian.gov.cn/" target="_blank"><?php echo $this->_var['icp_number']; ?></a> POWERED BY<a href="http://www.dscmall.cn/" target="_blank">拍拍街</a>2.0</p>
			<?php endif; ?>
		</div>
	</div>
