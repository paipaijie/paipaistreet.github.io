...
?>
                <div class="exchange-score">
                    ...
                    <div class="score-info">
                        <div class="item">
                            <p><?php echo $this->_var['lang']['available_integral']; ?></p>
                            <div class="num"><?php echo $this->_var['info']['pay_points']; ?></div>
                        </div>
                        <div class="item">
                            <p><?php echo $this->_var['lang']['balance_alt']; ?></p>
                    ...
                    <div class="u-info">
                        ...
                        <div class="u-name"><strong>Hi,<?php echo $this->_var['lang']['Welcome_to']; ?><?php echo $GLOBALS['_CFG']['shop_name']; ?></strong></div>
                    </div>
                    <div class="score-info">
                        <a href="<?php echo $this->_var['site_domain']; ?>user.php" class="login-button"><?php echo $this->_var['lang']['please_login']; ?></a>
                        <a href="user.php?act=register" class="register_button"><?php echo $this->_var['lang']['reg_now']; ?></a>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="exchange-main">
            <div class="w w1200">
                <div class="mod-list-sort">
                    ...
                    <div class="sort-l">
                        <a href="exchange.php?sort=goods_id&order=<?php if ($this->_var['pager']['search']['sort'] == 'goods_id' && $this->_var['pager']['search']['order'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>#exchange_list" class="sort-item <?php if ($this->_var['pager']['search']['sort'] == 'goods_id'): ?> curr<?php endif; ?>"><?php echo $this->_var['lang']['default']; ?><i class="iconfont <?php if ($this->_var['pager']['search']['sort'] == 'goods_id' && $this->_var['pager']['search']['order'] == 'ASC'): ?>icon-up1<?php else: ?>icon-down1<?php endif; ?>"></i></a>
                        <a href="exchange.php?sort=sales_volume&order=<?php if ($this->_var['pager']['search']['sort'] == 'sales_volume' && $this->_var['pager']['search']['order'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>#exchange_list" class="sort-item <?php if ($this->_var['pager']['search']['sort'] == 'sales_volume'): ?>curr<?php endif; ?>"><?php echo $this->_var['lang']['exchange_number']; ?><i class="iconfont <?php if ($this->_var['pager']['search']['sort'] == 'sales_volume' && $this->_var['pager']['search']['order'] == 'ASC'): ?>icon-up1<?php else: ?>icon-down1<?php endif; ?>"></i></a>
                        <a href="exchange.php?sort=exchange_integral&order=<?php if ($this->_var['pager']['search']['sort'] == 'exchange_integral' && $this->_var['pager']['search']['order'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>#exchange_list" class="sort-item <?php if ($this->_var['pager']['search']['sort'] == 'exchange_integral'): ?>curr<?php endif; ?>"><?php echo $this->_var['lang']['integral_value']; ?><i class="iconfont <?php if ($this->_var['pager']['search']['sort'] == 'exchange_integral' && $this->_var['pager']['search']['order'] == 'ASC'): ?>icon-up1<?php else: ?>icon-down1<?php endif; ?>"></i></a>
                    </div>
                </div>
...
?>
                            <?php if ($this->_var['goods']['goods_id']): ?>
                                <li class="mod-shadow-card">
                                    <a  href="<?php echo $this->_var['goods']['url']; ?>" target="_blank" class="img"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"></a>
                                    <div class="clearfix">
                                    ...
                                    <a  href="<?php echo $this->_var['goods']['url']; ?>" target="_blank" class="name" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><?php echo $this->_var['goods']['name']; ?></a>
                                    <div class="already">
