...
?>
        ...
        <div class="nav-main" id="nav">
            <ul class="navitems">
            	<li><a href="coupons.php?act=coupons_index" <?php if ($_GET['act'] == "coupons_index"): ?>class="curr"<?php endif; ?>><?php echo $this->_var['lang']['home']; ?></a></li>
                <li><a href="coupons.php?act=coupons_list" <?php if ($_GET['act'] == "coupons_list"): ?>class="curr"<?php endif; ?>><?php echo $this->_var['lang']['Good_coupon_market']; ?></a></li>
                <li><a href="coupons.php?act=coupons_goods" <?php if ($_GET['act'] == "coupons_goods"): ?>class="curr"<?php endif; ?>><?php echo $this->_var['lang']['task_mart']; ?></a></li>
            </ul>
        </div>
    </div>
</div>
