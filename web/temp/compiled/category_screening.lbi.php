                    ...
                    <div class="s-l-value brand_select_more">
                        <div class="all_a_z">
                            <ul class="a_z">
                                ...
                                <?php $_from = $this->_var['letter']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'letter_0_29237500_1534989081');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['letter_0_29237500_1534989081']):
?>
                                <li data-key="<?php echo $this->_var['letter_0_29237500_1534989081']; ?>"><?php echo $this->_var['letter_0_29237500_1534989081']; ?></li>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        ...
                        <div class="wrap_brand">  
                            <div class="brand_div">
                                <?php $_from = $this->_var['brands']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'brand_0_29237500_1534989081');if (count($_from)):
    foreach ($_from AS $this->_var['brand_0_29237500_1534989081']):
?>
                                <div class="brand_img_word" brand ="<?php echo $this->_var['brand_0_29237500_1534989081']['brand_letters']; ?>">
                                    <?php if ($this->_var['brand_0_29237500_1534989081']['brand_logo']): ?>
                                        <a href="<?php echo $this->_var['brand_0_29237500_1534989081']['url']; ?>">
                                        	<img src="<?php echo $this->_var['brand_0_29237500_1534989081']['brand_logo']; ?>" alt="<?php echo $this->_var['brand_0_29237500_1534989081']['brand_name']; ?>" title="<?php echo $this->_var['brand_0_29237500_1534989081']['brand_name']; ?>"> 
                                        	<span><?php echo $this->_var['brand_0_29237500_1534989081']['brand_name']; ?></span>
                                        </a>
                                    <?php else: ?>
                                        <a href="<?php echo $this->_var['brand_0_29237500_1534989081']['url']; ?>"><b><?php echo $this->_var['brand_0_29237500_1534989081']['brand_name']; ?></b></a> 
                                    <?php endif; ?>
                                </div>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                            </div>
    ...
    foreach ($_from AS $this->_var['brand_0_29237500_1534989081']):
?>
                                <li class="is_no" brand ="<?php echo $this->_var['brand_0_29237500_1534989081']['brand_letters']; ?>" url_id="<?php echo $this->_var['brand_0_29237500_1534989081']['brand_id']; ?>"><span class="choose_ico"></span><a class="goods_brand_name" data-url="<?php echo $this->_var['brand_0_29237500_1534989081']['url']; ?>"><?php echo $this->_var['brand_0_29237500_1534989081']['brand_name']; ?></a></li>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                            </ul>
                        </div>
