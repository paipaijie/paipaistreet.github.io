...
?>
    ...
    <div class="categorys-item<?php if ($this->_var['nav_cat_model']): ?> nav_cat_model<?php endif; ?>" ectype="cateItem" data-id="<?php echo $this->_var['cat_0_59572100_1535422894']['id']; ?>" data-eveval="0">
        <div class="item item-content">
            <?php if ($this->_var['cat_0_59572100_1535422894']['style_icon'] == 'other'): ?>
            <?php if ($this->_var['cat_0_59572100_1535422894']['cat_icon']): ?><div class="icon-other"><img src="<?php echo $this->_var['cat_0_59572100_1535422894']['cat_icon']; ?>" alt="分类图标"></div><?php endif; ?>
            <?php else: ?>
            <i class="iconfont icon-<?php echo $this->_var['cat_0_59572100_1535422894']['style_icon']; ?>"></i>
            <?php endif; ?>
            <div class="categorys-title">
                <strong>
                <?php if ($this->_var['cat_0_59572100_1535422894']['category_link'] == 1): ?>
