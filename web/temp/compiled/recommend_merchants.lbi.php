...
?>
						<li>
							<a href="<?php echo $this->_var['ad_0_59272100_1535422894']['ad_link']; ?>">
								<img src="<?php echo $this->_var['ad_0_59272100_1535422894']['ad_code']; ?>" width="<?php echo $this->_var['ad_0_59272100_1535422894']['ad_width']; ?>" height="<?php echo $this->_var['ad_0_59272100_1535422894']['ad_height']; ?>" alt="" class="cover">
								<div class="logo-wrap"><div class="sbs-logo"><img src="<?php echo $this->_var['ad_0_59272100_1535422894']['ad_bg_code']; ?>" alt=""></div></div>
								<div class="intro">
...
?>
		<div class="rec-store-item opacity_img">
			<a href="<?php echo $this->_var['ad_0_59272100_1535422894']['ad_link']; ?>" target="_blank">
            <div class="p-img"><img src="<?php echo $this->_var['ad_0_59272100_1535422894']['ad_code']; ?>" width="<?php echo $this->_var['ad_0_59272100_1535422894']['ad_width']; ?>" height="<?php echo $this->_var['ad_0_59272100_1535422894']['ad_height']; ?>"></div>
            <div class="info">
                <div class="s-logo"><div class="img"><img src="<?php echo $this->_var['ad_0_59272100_1535422894']['ad_bg_code']; ?>"></div></div>
                <div class="s-title">
