        ...
        <div class="content">
            ...
            <div class="flexilist">
            	<div class="common-head">
                	...
                	<div class="fl">
                        <a href="paipai_buy.php?act=add"><div class="fbutton"><div class="add" title="<?php echo $this->_var['lang']['add_group_buy']; ?>"><span><i class="icon icon-plus"></i><?php echo $this->_var['lang']['add_group_buy']; ?></span></div></div></a>
                    </div>
                    <?php endif; ?>
               ...
               <!---拍拍活动详情列表  开始 ---> 
				...
				<form method="post" action="paipai_buy.php?act=batch_drop" name="listForm" onsubmit="return confirm(batch_drop_confirm);">
...
?>
                            	<tr>
                                	<td class="sign">
                                        <div class="tDiv">
                                            <input type="checkbox" name="checkboxes[]" value="<?php echo $this->_var['group_buy']['ppj_id']; ?>" class="checkbox" id="checkbox_<?php echo $this->_var['group_buy']['ppj_id']; ?>" />
                                            <label for="checkbox_<?php echo $this->_var['group_buy']['ppj_id']; ?>" class="checkbox_stars"></label>
                                        </div>
                                    </td>
                                    <td><div class="tDiv"><?php echo $this->_var['group_buy']['ppj_id']; ?></div></td>
                                	<td>
                                    ...
                                    <td><div class="tDiv"><span onclick="listTable.edit(this, 'edit_deposit', <?php echo $this->_var['group_buy']['ppj_id']; ?>)"><?php echo $this->_var['group_buy']['ppj_margin_fee']; ?></span></div></td>
									
                                    <td><div class="tDiv"><span onclick="listTable.edit(this, 'edit_restrict_amount', <?php echo $this->_var['group_buy']['ppj_id']; ?>)"><?php echo $this->_var['group_buy']['goods_count']; ?></span></div></td>
                                    ...
                                    <td><div class="tDiv"><?php echo $this->_var['group_buy']['ppj_now_fee']; ?></div></td>
                                    ...
                                    <td class="handle">
										<div class="tDiv ht_tdiv">
                                            ...
                                            <a href="paipai_buy.php?act=edit&amp;id=<?php echo $this->_var['group_buy']['ppj_id']; ?>" class="btn_edit" title="<?php echo $this->_var['lang']['edit']; ?>"><i class="icon icon-edit"></i><?php echo $this->_var['lang']['edit']; ?></a>
                                            <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['group_buy']['ppj_id']; ?>,'<?php echo $this->_var['lang']['drop_confirm']; ?>')" class="btn_trash" title="<?php echo $this->_var['lang']['remove']; ?>"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['drop']; ?></a>					
										</div>
									</td>
                                </tr>
							<?php endforeach; else: ?>
...
?>
	...
	$(document).on("click","#del", function () {
        ...
        $.ajax({
            url:"paipai_buy.php?act=remove",
            type:"GET",
            data:{
				val:"del",
                id:<?php echo $this->_var['group_buy']['goods_id']; ?>
            },
            success: function (res) {
                if(res = true){
                    alert("删除成功");
					location.href="paipai_buy.php?act=list";
                }else{
                    alert("删除失败");
                }
            }
