	...
	<div class="warpper">
        ...
        <div class="content">		
        	<div class="explanation" id="explanation">
                ...
                <ul>
                    <?php if ($this->_var['standard_goods']): ?>
            ...
            <div class="flexilist">
                <div class="common-head">
                	<?php if (! $this->_var['standard_goods']): ?>
                    <div class="fl">
						<a href="goods_lib.php?act=add<?php if ($this->_var['code'] == 'virtual_card'): ?>&extension_code=virtual_card<?php endif; ?>"><div class="fbutton"><div class="add" title="<?php echo $this->_var['lang']['add_product']; ?>"><span><i class="icon icon-plus"></i><?php echo $this->_var['lang']['add_product']; ?></span></div></div></a>
                        <a href="goods_lib_batch.php?act=add"><div class="fbutton"><div class="edit" title="<?php echo $this->_var['lang']['batch_file']; ?>"><span><i class="icon icon-upload-alt"></i><?php echo $this->_var['lang']['batch_file']; ?></span></div></div></a>
						<a href="goods_lib.php?act=import_seller_goods"><div class="fbutton"><div class="edit" title="<?php echo $this->_var['lang']['dr_seller_goods']; ?>"><span><i class="icon icon-upload-alt"></i><?php echo $this->_var['lang']['dr_seller_goods']; ?></span></div></div></a>
                    </div>
                    <?php endif; ?>
                    <div class="refresh">
					...
					<div class="search">
                    	...
                    	<div class="input">
                        	<input type="text" name="keyword" class="text nofocus w140" placeholder="<?php echo $this->_var['lang']['goods_search_placeholder']; ?>" autocomplete="off">
                    	...
                    	<table cellpadding="0" cellspacing="0" border="0">
                        	<thead>
                            	<tr>
                                    ...
                                    <?php if ($this->_var['standard_goods']): ?>
                                    <th width="11%"><div class="tDiv"><?php echo $this->_var['lang']['suppliers_name']; ?></div></th>
                                    <?php endif; ?>
                                    <th width="11%"><div class="tDiv"><?php if (! $this->_var['standard_goods']): ?><?php echo $this->_var['lang']['goods_lib_cat']; ?><?php else: ?><?php echo $this->_var['lang']['wholesale_cat']; ?><?php endif; ?></div></th>
                                    ...
                                    <th width="8%"><div class="tDiv"><?php echo $this->_var['lang']['on_sale']; ?></div></th>
...
?>
                            	<tr>
                                    ...
                                    <td>
                                        <div class="tDiv">
                                            <span class="label"><?php echo $this->_var['goods']['suppliers_name']; ?></span>
                                        </div>
                                    </td>
                                    <?php endif; ?>
                                    <td>
									...
									<td class="handle">
                                        <div class="tDiv ht_tdiv" style="padding-bottom:0px;">
                                            <p>
                                            	...
                                            	<?php else: ?>
                                                <a href="../wholesale_goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="btn_see"><i class="sc_icon sc_icon_see"></i><?php echo $this->_var['lang']['view']; ?></a>
                                                <?php endif; ?>
                            	...
                            	<tr>
                                	<td colspan="12">
                                    	<div class="tDiv">
                                            ...
                                            <?php endif; ?>
                                            <div class="list-page"><?php echo $this->fetch('library/page.lbi'); ?></div>
                                        </div>
                                    </td>
                                </tr>
                            </tfoot>
	...
	*/
	...
	$(document).on("click","input[name='goods_model_price']",function(){
		...
		$.jqueryAjax('dialog.php', 'act=add_goods_model_price' + '&goods_id=' + goods_id, function(data){
			...
			pb({
				id:"categroy_dialog",
				title:"<?php echo $this->_var['lang']['w_r_price']; ?>",
				width:864,
				content:content,
				ok_title:"<?php echo $this->_var['lang']['button_submit_alt']; ?>",
				cl_title:"<?php echo $this->_var['lang']['cancel']; ?>",
	...
	$(document).on("click","a[ectype='add_sku']",function(){
		...
		$.jqueryAjax('dialog.php', 'act=add_sku' + '&goods_id=' + goods_id + '&user_id=' + user_id, function(data){
			...
			pb({
				id:"categroy_dialog",
				title:"<?php echo $this->_var['lang']['edit_goods_sku_info']; ?>",
				width:863,
				content:content,
				ok_title:"<?php echo $this->_var['lang']['button_submit_alt']; ?>",
				cl_title:"<?php echo $this->_var['lang']['cancel']; ?>",
						...
						'<div class="item fl" style="width:333px">' +
							...
							'<div class="checkbox_items" style="padding-top:10px; width:80%">' +
								'<div class="checkbox_item">' + 
									...
									'<label for="pro_no" class="ui-radio-label"><?php echo $this->_var['lang']['not_audited']; ?></label>' +
								'</div>' +
								'<div class="checkbox_item">' + 
									...
									'<label for="pro_no" class="ui-radio-label"><?php echo $this->_var['lang']['audited_yes_adopt']; ?></label>' +
								'</div>' +
