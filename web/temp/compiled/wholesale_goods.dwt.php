                        ...
                        <div class="g-main g-history">
                            ...
                            <div class="mc">
                                <div class="mc-warp" id="history_list">
                                    <ul>
                                        <?php $_from = $this->_var['see_more_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_97042300_1535055981');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_97042300_1535055981']):
?>
                                        <li>
                                            <div class="p-img"><a href="<?php echo $this->_var['goods_0_97042300_1535055981']['goods_url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods_0_97042300_1535055981']['goods_name']); ?>"><img src="<?php echo $this->_var['goods_0_97042300_1535055981']['goods_thumb']; ?>" width="170" height="170"></a></div>
                                            <div class="p-name"><a href="<?php echo $this->_var['goods_0_97042300_1535055981']['goods_url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods_0_97042300_1535055981']['goods_name']); ?>"><?php echo $this->_var['goods_0_97042300_1535055981']['goods_name']; ?></a></div>
                                            <div class="p-lie">
                                                <div class="p-price">
                                                    <?php echo $this->_var['goods_0_97042300_1535055981']['price']; ?>
                                                </div>
                                            </div>
                                        </li>
                                        <?php endforeach; else: ?>
